...
Refactored for Azure Functions
"""
            ...
            if response.status_code == 403:
                ...
                if 'cmdb_sam_sw_install' in endpoint:
                    ...
                    if 'cmdb_sam_sw_install' not in self.permission_warnings:
                        ...
                        logger.warning("Permission denied for cmdb_sam_sw_install table. Requires 'sam_user' or 'asset' role.")
                else:
                    logger.warning(f"Access denied to {endpoint} - insufficient permissions")
                return None
            response.raise_for_status()
...
class VulnerabilityAnalyzer:
    ...
    def analyze_vulnerability(self, vuln_id: str, fetch_all_details: bool = False, 
        ...
        Args:
            ...
            fetch_all_details: If True, fetch details for all systems
            include_patched: If True, include patched systems
    ...
    def _analyze_qid(self, qid_number: str, results: Dict) -> Dict:
        ...
        if not third_party_result or not third_party_result.get('result'):
            logger.warning(f"QID-{qid_number} not found")
            return results
    ...
    def _get_vulnerable_items(self, results: Dict, fetch_all_details: bool,
        ...
        """Get vulnerable items and system details."""
